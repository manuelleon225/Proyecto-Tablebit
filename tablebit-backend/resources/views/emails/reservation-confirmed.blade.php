            ...
            <div class="body">
                ...
                <div class="details">
                    <table>
                        ...
                        <tr>
                            <td>Mesa</td>
                            <td>{{ $reserva->mesa ? 'Mesa ' . $reserva->mesa->numero : 'Asignada automáticamente' }}</td>
                        </tr>
                        <tr>
                            <td>Estado</td>
                            <td>{{ match($reserva->estado) { 'confirmada' => 'Confirmada', 'pendiente' => 'Pendiente', default => $reserva->estado } }}</td>
                        </tr>
                    </table>
                </div>
