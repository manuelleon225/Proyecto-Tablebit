...
<head>
    ...
    <title>Reserva confirmada - TableBit</title>
    <style>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="body">
                ...
                <p>Hola, <strong>{{ $reserva->cliente->name ?? 'usuario' }}</strong>. Tu reserva ha sido confirmada exitosamente.</p>
                ...
                <div class="detail-box">
                    <table>
                        ...
                        <tr><td>Mesa</td><td>{{ $reserva->mesa ? 'Mesa ' . $reserva->mesa->numero : 'Asignada automáticamente' }}</td></tr>
                        <tr><td>Estado</td><td>{{ match($reserva->estado) { 'confirmada' => 'Confirmada', 'pendiente' => 'Pendiente', default => $reserva->estado } }}</td></tr>
                    </table>
                </div>
                ...
                <p>Si tienes alguna pregunta, contacta directamente al restaurante.</p>
